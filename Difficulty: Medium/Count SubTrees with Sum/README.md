<h2><a href="https://www.geeksforgeeks.org/problems/count-number-of-subtrees-having-given-sum/1">Count SubTrees with Sum</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color); --darkreader-text--text-color: var(--darkreader-text--problem-text-color); --darkreader-border--text-color: var(--darkreader-border--problem-text-color);"><p data-pm-slice="0 0 []"><span style="font-size: 14pt;">You are given a <strong>root</strong> of&nbsp; binary tree and an integer <strong>x</strong>. Your task is to count the number of subtrees whose sum of all node values is equal to <strong>x</strong>. </span><span style="font-size: 14pt;">The sum of a subtree is the sum of all node values within it.</span></p>
